...
public class Individual {
    ...
    public Individual(double Ix, double Iy) {
    ...
    public boolean infection() {
        ArrayList<Individual> Individual = SIRSimulation.getCitizens();
    ...
    public void move() {
        ...
        for (Events e : SIRSimulation.getEvents()) {
            if (loc.distanceTo(e.eventLocation) < e.radius) {
                loc.moveTowards(dir,e.eventLocation,BOUNDARY);
            }
        }
